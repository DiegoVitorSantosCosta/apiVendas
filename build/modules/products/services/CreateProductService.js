...
class CreateProdutsService {
    ...
    execute({ name, price, quantity }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const productExists = yield produtsRepository.findByName(name);
            if (productExists) {
                throw new AppErros_1.default('Product already exists');
            }
            ...
            yield produtsRepository.save(product);
            return product;
        });
    }
}
exports.default = CreateProdutsService;
